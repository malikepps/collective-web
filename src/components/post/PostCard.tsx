...
export default function PostCard({
  ...
  return (
    ...
    >
      ...
      {mediaItems.length > 0 && (
        <div className="relative overflow-hidden" style={{ borderTopLeftRadius: '0.75rem', borderTopRightRadius: '0.75rem', maxHeight: '60vh' }}>
          ...
          {/* Media */}
          <div onClick={onShowDetail} className="w-full h-full">
            <MediaCarousel 
